...
replacement).  That is how a population of size 10 represents 10,000,000,000 samples.
...
it represents the middle 95% of the distribution. 
...
not make it possible to say that there is a certain percent probability that the true 
