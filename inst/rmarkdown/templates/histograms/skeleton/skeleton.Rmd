...
````{r}
addhealth %>% ggvis(~age) %>% layer_histograms()
...
```{r}
 addhealth %>% ggvis(~age) %>% layer_histograms()  %>% add_axis("x", title = "Age") %>% 
  add_axis("y", title = "Count") 
...
```{r}
 ...
 addhealth %>% ggvis(~age) %>% layer_histograms(fill := "pink", stroke="blue")
...
```{r}
 addhealth %>% ggvis(~age) %>% layer_histograms(width=5, center = 0)
 addhealth %>% ggvis(~age) %>% layer_histograms(width=1, center = .5)
```
