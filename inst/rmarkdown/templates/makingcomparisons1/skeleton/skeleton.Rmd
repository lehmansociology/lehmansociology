...
*Lines showing how far 1.5 * the Interquartile range would extend above and below the boxes.
...
# You can add any othe statistics you want, such as max() or min()
comparison_poverty<-education_and_poverty %>% group_by(region) %>% summarize(mean(PCTPOVALL_2013), median(PCTPOVALL_2013), IQR(PCTPOVALL_2013))
xtable(comparison_poverty)
